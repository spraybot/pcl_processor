...
void CropBox<PointT>::declare_parameters(rclcpp::Node::SharedPtr & node)
{
  ...
  node->declare_parameter<std::vector<double>>(this->plugin_name_ + ".min", {-1.0, -1.0, -1.0});
  node->declare_parameter<std::vector<double>>(this->plugin_name_ + ".max", {1.0, 1.0, 1.0});
